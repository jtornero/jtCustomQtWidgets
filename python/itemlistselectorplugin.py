...
from isplugin.itemlistselector import ItemListSelector

class ItemListSelectorPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def createWidget(self, parent):
        ...
        return ItemListSelector(parent)
    ...
    def toolTip(self):
        return "Move elements between two QListWidgets"
    ...
    def domXml(self):
        return '<widget class="ItemListSelector" name="itemListSelector" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "isplugin.itemlistselector"


# Define the image used for the icon.
_logo_32x32_xpm = ["32 32 55 1",
