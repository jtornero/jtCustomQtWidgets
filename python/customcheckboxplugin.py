...
from isplugin.customcheckbox import CustomCheckBox

class CustomCheckBoxPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def toolTip(self):
        return "Custom CheckBox with return pressed signals"
    ...
    def domXml(self):
        return '<widget class="CustomCheckBox" name="cusCheckBox" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "isplugin.customcheckbox"
