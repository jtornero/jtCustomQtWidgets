...
from isplugin.customspinbox import CustomSpinBox

class CustomSpinBoxPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def toolTip(self):
        return "Custom SpinBox with return pressed signals"
    ...
    def domXml(self):
        return '<widget class="CustomSpinBox" name="cusSpinBox" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "isplugin.customspinbox"
