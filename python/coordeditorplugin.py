...
from isplugin.coordinateEditor import CoordinateEditor

class CoordEditorPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def createWidget(self, parent):
        ...
        return CoordinateEditor(parent)
    ...
    def domXml(self):
        return '<widget class="CoordinateEditor" name="coordEdit" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "isplugin.coordinateEditor"
