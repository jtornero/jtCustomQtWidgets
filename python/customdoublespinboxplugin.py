...
from isplugin.customdoublespinbox import CustomDoubleSpinBox

class CustomDoubleSpinBoxPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def createWidget(self, parent):
        ...
        return CustomDoubleSpinBox(parent)

    def name(self):
        return "CustomDoubleSpinBox"
    ...
    def toolTip(self):
        return "Custom DoubleSpinBox with return pressed signals"
    ...
    def domXml(self):
        return '<widget class="CustomDoubleSpinBox" name="cusDoubleSpinBox" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "isplugin.customdoublespinbox"
