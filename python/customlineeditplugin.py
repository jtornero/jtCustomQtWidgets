...
from isplugin.customlineedit import CustomLineEdit

class CustomLineEditPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def toolTip(self):
        return "Custom LineEdit with return pressed signals"
    ...
    def domXml(self):
        return '<widget class="CustomLineEdit" name="cusLineEdit" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "isplugin.customlineedit"
