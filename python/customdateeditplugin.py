...
from isplugin.customdateedit import CustomDateEdit

class CustomDateEditPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def createWidget(self, parent):
        ...
        return CustomDateEdit(parent)

    def name(self):
        return "CustomDateEdit"
    ...
    def toolTip(self):
        return "Custom DateEdit with return pressed signals"
    ...
    def domXml(self):
        return '<widget class="CustomDateEdit" name="cusDateEdit" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "isplugin.customdateedit"
